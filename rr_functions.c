...
ldns_rr_a_address(const ldns_rr* r)
{
  ...
  if (!r || (ldns_rr_get_type(r) != LDNS_RR_TYPE_A && ldns_rr_get_type(r) != LDNS_RR_TYPE_AAAA)) {
    return NULL;
  }
                                     ...
                                     ldns_soa_serial_increment_func_t f, void* data)
{
  ...
  prev_soa_serial_rdf = ldns_rr_set_rdf(
    soa, ldns_native2rdf_int32(LDNS_RDF_TYPE_INT32, (*f)(ldns_rdf2native_int32(ldns_rr_rdf(soa, 2)), data)), 2);
